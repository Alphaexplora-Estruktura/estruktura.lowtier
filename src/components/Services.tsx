            ...
            <div className="relative z-10 max-w-[90rem] mx-auto px-6 lg:px-16 py-[clamp(5rem,12vw,8rem)]">
                ...
                >
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-10 lg:gap-20 items-end">
                        ...
                        {/* Right: description + CTA flush to bottom */}
                        <div className="lg:pb-2 flex flex-col gap-8">
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-2.5 px-7 py-3 border border-[#8c7e71] text-[#1C1915] text-[0.65rem] font-bold uppercase tracking-widest rounded-sm self-start
                                    transition-colors duration-200 ease-[cubic-bezier(0.23,1,0.32,1)]
                                    hover:bg-[#8c7e71] hover:text-[#F4F1EA]
                                    active:scale-[0.97]"
                                style={{ transition: `background-color 200ms ${ease}, color 200ms ${ease}, transform 160ms ${ease}` }}
                            >
