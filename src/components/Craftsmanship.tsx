...
export default function Craftsmanship() {
    ...
    return (
        <section id="craftsmanship" className="bg-estruktura-bg overflow-hidden border-t border-estruktura-accent/20">
            ...
            {/* ── Full-width header ── */}
            <div className="py-[clamp(4rem,10vw,7rem)] px-6 lg:px-16 text-center max-w-[90rem] mx-auto">
            ...
            >
                <div className="group relative min-h-[clamp(280px,50vw,480px)] overflow-hidden">
                    <img
                        src={imgAta1}
            ...
            <div className="py-10 px-6 lg:px-16 border-t border-estruktura-accent/20">
                <div className="max-w-[90rem] mx-auto flex items-center justify-between">
                    ...
                    <a href="#gallery" className="inline-flex items-center min-h-[44px] text-estruktura-text hover:text-estruktura-gold font-bold text-xs uppercase tracking-[0.3em] transition-colors duration-300">
                        View Gallery →
                    </a>
                </div>
            </div>
